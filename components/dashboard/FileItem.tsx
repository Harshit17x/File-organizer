import { FileText, Image as ImageIcon, MoreVertical, Download, Trash2, File, Star } from "lucide-react";
...
export function FileItem({ id, name, type, date, size, isFavorite, storagePath, isSelected, onSelect, onDelete, onToggleFavorite }: FileItemProps) {
